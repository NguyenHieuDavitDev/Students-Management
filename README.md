...
#### 22.3. Service (GradeComponentService)
...
#### 23.3. Service (GraduationConditionService)
...
### 24. Quản Lý Thông Báo (Notification Management)
...
#### 24.2. Danh mục thông báo (NotificationCategory)
...
#### 24.3. Nghiệp vụ chính (NotificationService)
...
#### 24.5. Giao diện người dùng (User Dashboard)
...
#### 24.6. Giao diện quản trị (Admin Dashboard)
...
#### 24.7. Badge thông báo trên Header
...
#### 24.9. Repository (NotificationRepository)
...
#### 24.10. Tích hợp với các module khác
...
### 25. Quản Lý Thang Điểm & Bảng Điểm Tổng Kết (Grade Scale & Transcript)
...
#### 25.2. Quy trình tính điểm tổng kết (4 bước)
...
#### 25.6. Repository (GradeScaleRepository)
